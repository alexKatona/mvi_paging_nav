...
public class FragmentMviDelegateImpl<V extends MvpView, P extends MviPresenter<V, ?>>
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (DEBUG) {
            Timber.d("MosbyView ID = " + mosbyViewId + " for MvpView: " + delegateCallback.getMvpView());
        }
        ...
        if (mosbyViewId == null) {
            ...
            if (DEBUG) {
                Timber.d("new Presenter instance created: " + presenter);
            }
        } else {
            ...
            if (presenter == null) {
                ...
                viewStateWillBeRestored = false;
                if (DEBUG) {
                    Timber.d("No Presenter instance found in cache, although MosbyView ID present. This was caused by process death, therefore new Presenter instance created: "
                            + presenter);
                }
            } else {
                viewStateWillBeRestored = true;
                if (DEBUG) {
                    Timber.d("Presenter instance reused from internal cache: " + presenter);
                }
            }
        }
    ...
    public void onStart() {
        ...
        if (DEBUG) {
            Timber.d("MvpView attached to Presenter. MvpView: " + view + "   Presenter: " + presenter);
        }
    }
    ...
    public void onStop() {
        ...
        if (DEBUG) {
            Timber.d("detached MvpView from Presenter. MvpView "
    ...
    public void onDestroy() {
        ...
        if (!retainPresenterInstance) {
            ...
            Timber.d("Retaining presenter instance: "
    ...
    public void onSaveInstanceState(Bundle outState) {
        if ((keepPresenterDuringScreenOrientationChange || keepPresenterOnBackstack)
            ...
            if (DEBUG) {
                Timber.d("Saving MosbyViewId into Bundle. ViewId: " + mosbyViewId);
            }
        }
    }
